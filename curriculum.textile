...
standfirst: "Some notes about the curriculum"
---
...
It will be an opportunity for companies to test out: the quality of their support documentation, the quality of their APIs, the ease with which relatively inexperienced coders can work with the those APIs, and to get feedback from users.
...
I will probably also use Matthew Russell's book, "_Mining the Social Web_":http://www.amazon.co.uk/Mining-Social-Web-Facebook-LinkedIn-ebook/dp/B00FNBWNLU/ as a reference for one or two challenges.
...
h2. Some ideas on curriculum development

<dl>
  
dt. Curriculum review meetings

dd. Monthly meetings to discuss the course content. Open to "Coding the web" alumni. I am also in the early stages of gathering "faculty" members, i.e. anyone who is interested in helping out.

dt. Part-time evening study group

dd. For students studying the two Udacity courses used in "Coding the web".

dt. Follow up study: study groups

dd. Open-ended self-organising study groups, on any topic, for which we will provide support and space (presumably on one or two evenings of the week).

dt. Testing new material: hack days

dd. Day-long events, primarily to be used for testing new material for the course, to which alumni and others can be invited. Perhaps one Saturday per month.
  
dt. Weekend hackathons

dd. 48-hour events for working on bigger projects, suitable for alumni as well as people who have covered all the core curriculum (or equivalent) and have completed a few hack days.
