...
*Ruby on Rails* is a web application framework that is usually used for websites which are structured around pages that broadly reflect the structure of some underlying content, such as a code repository (GitHub) or a business directory (Yellow Pages) or a social network (Yammer) or a digital library (Scribd) or an online store (Shopify) or a project management tool (Basecamp). There are a lot of websites that answer to this broad description, which has led to it becoming perhaps the most widely used framework for building these sorts of websites.
