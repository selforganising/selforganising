...
The choice of Python as the server-side language is determined by it being the language used on Steve Huffman's course (as well as Udacity's CS101). But even if we put this deciding factor to one side, Python is easy to learn, powerful and widely used in many fields, not just web development. And although this course is about "coding the web", I don't want it to be _just_ about that. Python is a great all-round language to learn. It is also the language used for the examples in Matthew Russell's book, _Mining the Social Web_, which we will use as a reference for some of the challenges in the latter part of the course.
