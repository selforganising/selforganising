...
*PHP*, which many years ago became the default server-side language for countless small websites, many of which have since grown very large. It is more-or-less ubiquitous on most hosting services and makes it simple to do simple things. However, it is not a general-purpose programming language. For creating simple server-side behaviour it's good; for teaching the principles of programming, less so. It's useful for getting WordPress jobs, though.
