...
*PHP*, which many years ago became the default server-side language for countless small websites, many of which have since grown very large. It is more-or-less ubiquitous on most hosting services and is good For implementing simple server-side behaviour and for some more complex thnigs, too, but it is not a general-purpose programming language, and I am not that keen on using it for teaching people how to program. It's useful for getting WordPress jobs, though.
