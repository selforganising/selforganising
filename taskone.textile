...
dd. Because of the amount of material that we have to get through, it is probably more important that we try to keep to the schedule than that we complete every problem. In the second week there are fewer problem sets, but the lessons get more challenging.
...
dd. If you are already familiar with Python (or are a quick learner), the optional problem sets mean that you are unlikely to run out of material.
